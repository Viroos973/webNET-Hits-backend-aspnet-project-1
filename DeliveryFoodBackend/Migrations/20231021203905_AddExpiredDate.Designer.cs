...
namespace DeliveryFoodBackend.Migrations
{
    ...
    [Migration("20231021203905_AddExpiredDate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BasketDish", b =>
                {
                    b.HasOne("DeliveryFoodBackend.Data.Models.Basket", null)
                        .WithMany()
                        .HasForeignKey("BasketsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DeliveryFoodBackend.Data.Models.Dish", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DeliveryFoodBackend.Data.Models.Basket", b =>
                {
                    b.HasOne("DeliveryFoodBackend.Data.Models.Order", "Order")
                        .WithOne("Baskets")
                        .HasForeignKey("DeliveryFoodBackend.Data.Models.Basket", "OrderId");
